 ...
 * files
 */
public class Yeoh_project4_part2 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner inputFile;
        inputFile = new Scanner(creditCardNumbersFile);
        
        //grabbing numbers from the file
        while (inputFile.hasNext()) {
            cardNumberString = inputFile.nextLine();
            ...
            if (!checkNumbers) {
                System.out.println(cardNumberString + " cannot be processed");
                System.out.println();
            }
